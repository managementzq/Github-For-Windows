...
namespace Tianyue.Utility.Extension
{
    public static class DataTableExtension
    {
        ...
        {
            CommonCacheManager.DtColCache.Clear();
            CommonCacheManager.DtPropCache.Clear();
        }
        ...
        public static DataTable ToCacheDataTable<T>(this IEnumerable<T> list)
        {
            ...
            if (CommonCacheManager.DtColCache.TryGetValue(type, out dcList))
            {
            ...
            else
            {
                ...
                CommonCacheManager.DtColCache.Add(
                    type,
            ...
            if (CommonCacheManager.DtPropCache.TryGetValue(type, out pList) == false)
            {
                if (pList == null)
                {
                ...
                CommonCacheManager.DtPropCache.Add(type, pList);
            }
        ...
        public static List<T> CacheList<T>(this DataTable dt)
        {
            ...
            List<PropertyInfo> plist;
            if (CommonCacheManager.DtPropCache.TryGetValue(t, out plist) == false)
            {
                if (plist == null)
                {
                    plist = new List<PropertyInfo>(t.GetProperties());
                }
                CommonCacheManager.DtPropCache.Add(t, plist);
            }
