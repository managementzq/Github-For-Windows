...
namespace Tianyue.Wpf.Control
{
    ...
    public static class ControlAttachProperty
    {
        ...
        #region VectorIconProperty 字体图标
        /// <summary>
        /// 字体图标
        /// </summary>
        public static readonly DependencyProperty VectorIconProperty = DependencyProperty.RegisterAttached(
            "VectorIcon", typeof(string), typeof(ControlAttachProperty), new FrameworkPropertyMetadata(""));

        public static string GetVectorIcon(DependencyObject d)
        {
            return (string)d.GetValue(VectorIconProperty);
        }

        public static void SetVectorIcon(DependencyObject obj, string value)
        {
            obj.SetValue(VectorIconProperty, value);
        }
        #endregion

        #region VectorIconSizeProperty 字体图标大小
        /// <summary>
        /// 字体图标
        /// </summary>
        public static readonly DependencyProperty VectorIconSizeProperty = DependencyProperty.RegisterAttached(
            "VectorIconSize", typeof(double), typeof(ControlAttachProperty), new FrameworkPropertyMetadata(12D));

        public static double GetVectorIconSize(DependencyObject d)
        {
            return (double)d.GetValue(VectorIconSizeProperty);
        }

        public static void SetVectorIconSize(DependencyObject obj, double value)
        {
            obj.SetValue(VectorIconSizeProperty, value);
        }
        #endregion

        #region VectorIconMarginProperty 字体图标边距
        /// <summary>
        /// 字体图标
        /// </summary>
        public static readonly DependencyProperty VectorIconMarginProperty = DependencyProperty.RegisterAttached(
            "VectorIconMargin", typeof(Thickness), typeof(ControlAttachProperty), new FrameworkPropertyMetadata(null));

        public static Thickness GetVectorIconMargin(DependencyObject d)
        {
            return (Thickness)d.GetValue(VectorIconMarginProperty);
        }

        public static void SetVectorIconMargin(DependencyObject obj, Thickness value)
        {
            obj.SetValue(VectorIconMarginProperty, value);
        }
        #endregion
